...
public class TimeUtil {
    ...
    public static String getDateTimeFromMillisecond_two(Long millisecond){
    ...
    public static Long timeStrToSecond(String time) {
        //  String time = "2018-06-01 06:06:06";
        try {
     ...
     * @return
     */
    public static Long timeStrToSecond_SeckillDate(String time) {
        //  String time = "2018-06-01 06:06";
        try {
    ...
    public static Long getSpaceTime(Long millisecond) {
        ...
        Long currentMillisecond = calendar.getTimeInMillis();//当前时间的毫秒值

        //间隔秒
       // Long spaceSecond = (currentMillisecond - millisecond) / 1000;
        Long spaceSecond = (millisecond - currentMillisecond) / 1000;
