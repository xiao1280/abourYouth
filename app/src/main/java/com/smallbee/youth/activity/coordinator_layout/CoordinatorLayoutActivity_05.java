 ...
 * @time 2019/6/5  14:33
   ...
   参考:
       一篇文章学会Coordinatorlayout+AppbarLayout
        ...
        https://github.com/18380438200/CoordinatorlayoutFull
 */
public class CoordinatorLayoutActivity_05 extends AppCompatActivity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_coordinator_layout_05);
